...
<body>
    ...
    <div class="container border border-danger rounded-3 p-5 my-5">
        <h1 class="text-danger"><b>Oops.</b><br/>There was some problem processing your order.</h1>
        Your order is not processed. Please try again.<br/>
